package com.example.amars.cryptoking;
...
public class AES extends AppCompatActivity {
        ...
        enc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    //making a toast here to say encypted successfully
        ...
        dec.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    output_text.setText(outputstring);
                    //making a toast here to say decrypted successfully
        ...
        reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try{
                    ...
                    System.out.println("going for intent");
    ...
    private String encrypt(String data, String password_text) throws Exception {
        ...
        //Log.d("AMAR", "encrypt key:" + key.toString());
    ...
    private String decrypt(String data, String password_text) throws Exception {
       ...
       // Log.d("AMAR", "encrypt key:" + key.toString());
        ...
        byte[] decodedvalue = Base64.decode(data, Base64.DEFAULT);//was encoded on base64, so have to decode now
    ...
    private SecretKeySpec generateKey(String password) throws Exception {
        ...
        digest.update(bytes, 0, bytes.length);//processing bytes array 
