...
public class RSA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // generate a new public/private key pair to test with (note. amar you should only do this once and keep them!)
        ...
        enc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              //  Log.d("AMAR", "encrypt key:" +encrypted);
        ...
        dec.setOnClickListener(new View.OnClickListener() {
            ...
            //    Log.d("AMAR", "encrypt key:" +decrypted);
